...
I co-founded [Guimauve Digital](https://guimauve.digital) (France), an app studio crafting mobile apps and SaaS platforms. Our products include FlashUp (an educational flashcard app), ControlResell (a reselling productivity app), and iAPush (real-time App Store/Play Store alerts). There, I handle development and app marketing.
